# Harsh Jain — Full Stack Developer Portfolio

🌐 **Live:** [harshjain007.github.io/portfolio](https://harshjain007.github.io/portfolio/)
...
### Frontend
React.js · Redux · Redux-Thunk · JavaScript (ES6+) · TypeScript · HTML5 · CSS3 · Material UI · Bootstrap · PixiJS · Chart.js · React Router · React I18next · Framer Motion

### Backend
Node.js · Express.js · REST APIs · JWT Auth · Sequelize ORM · Middleware · WebRTC

### Databases
PostgreSQL · MongoDB

### Real-Time
Socket.IO · Zego Cloud · WebSockets

### DevOps & Cloud
Docker · AWS S3 · CloudFront · CI/CD · Git · GitHub

### Methodologies
Agile · Scrum · Component Architecture · Performance Profiling

---

## 💼 Professional Experience

### Full Stack Developer | Frontend Developer | Solution Engineer
**Gammastack (GrepRuby Webtech)** — Indore · Jun 2022 – Present
...
### Frontend Developer Intern | Solution Engineer
**Gammastack (GrepRuby Webtech)** — Indore · Jan 2022 – Jun 2022
...
### AfterHours / LiveChance — B2C Live Casino Gaming Platform
> Team of 2 · React.js · Redux · Node.js · Express.js · Sequelize · PostgreSQL · Docker · AWS S3 · Zego Cloud · Socket.IO
...
### PokerOne — Real-Time Poker Game
> Team of 4 · React.js · Redux · Node.js · Express.js · Sequelize · PostgreSQL · Socket.IO · JWT
...
### Redes Holding / GreenCage / Living Pixels / Roliify — B2B Multi-Gaming Platform
> Team of 3 · React.js · Redux · Socket.IO · PixiJS · Chart.js · Express.js · Sequelize · Material UI
...
Lakshmi Narain College of Technology Excellence · 2018 – 2022 · 8.33 CGPA

**Schooling**
St. Joseph's Convent School Kotma
